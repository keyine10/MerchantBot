export const MercariURLs = Object.freeze({
...
export const MercariSearchStatus = Object.freeze({
	DEFAULT: 'STATUS_DEFAULT',
	ON_SALE: 'STATUS_ON_SALE',
	SOLD_OUT: 'STATUS_SOLD_OUT',
});

export const MercariSearchSort = Object.freeze({
...
export const MercariSearchOrder = Object.freeze({
	DESC: 'ORDER_DESC',
	ASC: 'ORDER_ASC',
});

export const MercariItemStatus = Object.freeze({
...
export const MercariItemConditionId = Object.freeze({
	NEW: 1,
	ALMOSTNEW: 2,
	NOSCRATCHES: 3,
	SMALLSCRATCHES: 4,
...
export const MercariSearchCategoryID = Object.freeze({
